...
$titlepage          = "categories Course";
$linkaddpage        = "addcatcourses.php";
$titleaddpage       = "Add Category";
$linkeditpage       = "editcatcourses.php";
$linkdeletepage     = "deletecatcourses.php";
            ...
            <div class="panel panel-default panel-custom manage">
                ...
                <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-8 col-lg-9">
                                ...
                                if (isset($_GET['search'])) {
                                    $get = $_GET['search'];
                                    $and = "And (catcourses_name  LIKE  '%$get%') OR (catcourses_name_ar  LIKE  '%$get%') ";
                                } else {
                                    $and = null;
                                };
                                ?>
                    ...
                    <table class="table  table-bordered table-hover table-responsive table-section">
                        ...
                        <?php
                        $catcourese = getAllData("catcourses", "1 = 1  $and ORDER BY catcourses_id DESC")['values'];
                        foreach ($catcourese as $catcoures) {
                        ?>
                            <tr>
                                <td class=" "><?php echo $catcoures['catcourses_name']
                                                ?></td>
                                <td class="hidden-xs "><?php echo $catcoures['catcourses_name_ar']
                                                        ?></td>
                                <td>
                                    <a href="<?= $linkeditpage ?>?catcoursesid=<?= $catcoures['catcourses_id'] ?>&catcoures=<?php echo urlencode(serialize($catcoures)); ?>" class="btn-primary btn-sm mg-h-5 "> <i class="fa fa-edit"> </i> <span class="hidden-xs">Edit</span> </a>
                                    <a href="<?= $linkdeletepage ?>?catcoursesid=<?php echo  $catcoures['catcourses_id']
